...
const SignupForm = ({ formData, isLoading, handleChange, handleSubmit }) => {
  ...
  const calculatePasswordStrength = (password) => {
    ...
    // Cap at 5 for the 5 strength levels
  ...
  const allRequirementsMet = formData.password && 
  ...
  // Auto-set to strong if all requirements are met
  useEffect(() => {
    if (allRequirementsMet && passwordStrength < 4) {
      setPasswordStrength(4); // Set to "Strong" (index 4)
    }
  }, [allRequirementsMet, passwordStrength]);
            ...
            <button
              ...
              className={`w-full py-3 px-4 rounded-xl font-semibold text-white transition-all duration-200 transform ${
                isLoading
                  ...
                  : 'bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 shadow-lg hover:shadow-xl active:scale-95'
              }`}
            >
